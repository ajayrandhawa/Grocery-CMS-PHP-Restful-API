                      ...
                      <tr>
                        ...
                        <td>
                          <select onchange="location = this.value;">
                            ...
                            <option value="manage-orders.php?confirmid=<?php echo $result->orderid;?>">Confirmed
                            </option>
                            <option value="manage-orders.php?prepareid=<?php echo $result->orderid;?>">Prepared
                            </option>
                            <option value="manage-orders.php?wayid=<?php echo $result->orderid;?>">On Way
                            </option>
                            <option value="manage-orders.php?deliveredid=<?php echo $result->orderid;?>">Delivered
                            </option>
                            <option value="manage-orders.php?cancelid=<?php echo $result->orderid;?>">Cancelled
                            </option>
                          </select>
                        </td>
                      </tr>
