...
$sql="INSERT INTO items(name,category,description,price,image) VALUES(:name,:category,:description,:price,:images)";
...
<div class="col-sm-4">
<input type="number" name="itemprice" class="form-control" required placeholder="Per kg or piece">
</div>
