			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"><a href="manage-items.php"><i class="glyphicon glyphicon-circle-arrow-left" style="color:#3b3b3b"></i></a>&nbsp; &nbsp; Update Price</h2>
...
<label class="col-sm-2 control-label">Price<span style="color:red">* </span>(Rs)</label>
<div class="col-sm-4">
